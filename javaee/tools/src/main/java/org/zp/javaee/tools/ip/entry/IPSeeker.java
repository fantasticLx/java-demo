package org.zp.javaee.tools.ip.entry;
...
public class IPSeeker {
	...
	static {
		System.out.println("Addr: " + FileUtil.getResourcesPath());
	}

	private static final File IP_FILE = new File(FileUtil.getResourcesPath(), "/ip/QQWry.dat");
