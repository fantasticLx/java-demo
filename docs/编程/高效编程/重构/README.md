...
(1) [<u>过长函数(Long Method)</u>](http://www.cnblogs.com/jingmoxukong/p/6148339.html)
(2) [<u>过大的类(Large Class)</u>](http://www.cnblogs.com/jingmoxukong/p/6163538.html)
(3) [<u>基本类型偏执(Primitive Obsession)</u>](http://www.cnblogs.com/jingmoxukong/p/6178041.html)
(4) [<u>过长参数列表(Long Parameter List)</u>](http://www.cnblogs.com/jingmoxukong/p/6178411.html)
(5) [<u>数据泥团(Data Clumps)</u>](http://www.cnblogs.com/jingmoxukong/p/6178675.html)

## 滥用面向对象(Object-Orientation Abusers)

> ***这组坏味道意味着：代码部分或完全地违背了面向对象编程原则。***

(6) [<u>Switch 声明(Switch Statements)</u>](http://www.cnblogs.com/jingmoxukong/p/6178675.html)
(7) [<u>临时字段(Temporary Field)</u>](http://www.cnblogs.com/jingmoxukong/p/6179627.html)
(8) [<u>被拒绝的遗赠(Refused Bequest)</u>](http://www.cnblogs.com/jingmoxukong/p/6179920.html)
(9) [<u>异曲同工的类(Alternative Classes with Different Interfaces)</u>](http://www.cnblogs.com/jingmoxukong/p/6180182.html)

## 变革的障碍(Change Preventers)

> ***这组坏味道意味着：当你需要改变一处代码时，却发现不得不改变其他的地方。这使得程序开发变得复杂、代价高昂。***

(10) [<u>发散式变化(Divergent Change)</u>](http://www.cnblogs.com/jingmoxukong/p/6196267.html)
(11) [<u>霰弹式修改(Shotgun Surgery)</u>](http://www.cnblogs.com/jingmoxukong/p/6197153.html)
(12) [<u>平行继承体系(Parallel Inheritance Hierarchies)</u>](http://www.cnblogs.com/jingmoxukong/p/6197161.html)
